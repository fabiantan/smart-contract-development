...
contract('payable', function (accounts) {
  ...
  it('Should return BNB', async function () {
    await time.increaseTo(preSaleEndTime + 20) // Set to 20 second just after presale finish
    await this.loaPresale.returnBNB(8, { from: owner, value: '0', gas: '5000000' });

    await time.increaseTo(distributeStartTime + 1) // Set to 1 second just after distribute allowed
