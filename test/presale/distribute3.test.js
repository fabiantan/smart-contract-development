...
contract('payable', function (accounts) {
  ...
  before(async function () {
    ...
    // Time increase to 600 second after Presale start
    await time.increaseTo(preSaleStartTime + 600)
  ...
  it('Should return BNB', async function () {
    ...
    await time.increaseTo(distributeStartTime + 100 + 86400 * (1 - 1)) // Set to 1 days and 100 second just after distribute allowed
    ...
    await time.increaseTo(distributeStartTime + 100 + 86400 * (5 - 1)) // Set to 5 days and 100 second just after distribute allowed
    ...
    await time.increaseTo(distributeStartTime + 200 + 86400 * (20 - 1)) // Set to 20 days and 200 second just after distribute allowed
