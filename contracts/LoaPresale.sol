...
contract LoaPreSale {
    ...
    uint public constant _bnbAmountCap = 156.25 ether; // Allow cap at 156.25 BNB, return the remaining amount back to the deposit address
    uint public constant _dailyRewardPerBnb = 64; // Every day 156.25 * 64 = 10,000 sent

    // Dates
    uint public constant _NOV_21_2021_00_00_00 = 1_637_452_800; // Presale starts at Nov 21 2021 8am Malaysian time
    uint public constant _NOV_22_2021_00_00_00 = 1_637_539_200; // Presale ends at Nov 22 2021 8am Malaysian time
    uint public constant _DEC_12_2021_00_00_00 = 1_639_267_200; // First distribution starts at DEC 12 2021 8am Malaysian time
